...
const HeroSection = () => {
  return (
    <div className="w-full min-h-screen flex justify-between items-center gap-x-8 max-md:flex-col-reverse">
      <div className="w-[40%] mx-auto flex flex-col justify-center items-start max-md:w-4/5 max-md:mx-auto">
        ...
        <button className="px-4 py-2 rounded-md outline outline-blue-500 my-4 hover:bg-blue-500 hover:text-white transition-all duration-200">
          <a
      ...
      <div className="w-[40%] flex justify-center items-center p-6 max-md:w-4/5 max-md:mx-auto">
        <img
          src={userImg}
          alt="hero"
